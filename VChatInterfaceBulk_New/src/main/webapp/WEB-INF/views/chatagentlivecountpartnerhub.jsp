			...
			<div class="container" align="center"></div>
                ...
                <div style="width:100%;">
					<div class="card bgcrd">
						<div class="card-body">
							<button class="btn btn-sm" style="margin-top: -0px;" onclick="location.href='agentlivecountAction?hub=${objHubResp}'">Back</button>
							<div class="x_content">
								<h4 class="page-title" align="center"><mark>Partner Circle Wise -- ${objPNResp}</mark></h4>
