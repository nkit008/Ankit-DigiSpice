										...
										<form action="resetpasswordAction"
											...
											<p style="font-size:16px;font-weight:bold;margin-top:2%;margin-bottom:3%;">Change Password</p>
												...
												<div class="form-group">
													...
													<input type="text" name="partnerName" id="partnerName" class="col-md-4" readonly style="background-color: #cca5bc;"/>	
												</div>
												
												
												<div class="form-group">
													<label class="control-label col-md-3 blckcolor" for="userName" style="text-align:right;padding-right:40px;">User Name</label>		
													<input type="text" name="userName" id="userName" class="col-md-4" readonly style="background-color: #cca5bc;"/>	
												</div>
										...
										<form action="resetpasswordAction"
											...
											<p style="font-size:16px;font-weight:bold;margin-top:2%;margin-bottom:3%;">Delete User</p>
												...
												<div class="form-group">
													...
													<input type="text" name="delpartnerName" id="delpartnerName" class="col-md-4" readonly style="background-color: #cca5bc;"/>	
												</div>
												
												
												<div class="form-group">
													<label class="control-label col-md-3 blckcolor" for="deluserName" style="text-align:right;padding-right:40px;">User Name</label>		
													<input type="text" name="deluserName" id="deluserName" class="col-md-4" readonly style="background-color: #cca5bc;"/>	
												</div>
												
													<div class="form-group">
													<label class="control-label col-md-3 blckcolor" for="deluserRole" style="text-align:right;padding-right:40px;">User Role</label>		
													<input type="text" name="deluserRole" id="deluserRole" class="col-md-4" readonly style="background-color: #cca5bc;"/>	
												</div>
												...
												<div class="form-group">
													...
													<input type="text" name="deluserPassword" id="deluserPassword" class="col-md-4" readonly style="background-color: #cca5bc;"/>	
												</div>
