									...
									<form action="agentmanagerupdateAction"
										...
										<p>Agent Request Status</p>
											...
											<div class="form-group">
												...
												placeholder="" required="required" autocomplete="off" readonly style="background-color: #cca5bc;"/>	
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												placeholder="" autocomplete="off" readonly="readonly" style="background-color: #cca5bc;"/>	
											</div>
