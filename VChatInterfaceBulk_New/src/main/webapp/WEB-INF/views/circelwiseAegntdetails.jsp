...
<div class="" style="width:100%;">
					<div class="card bgcrd">
						<div class="card-body">
							<div class="x_content">
								<h4 class="page-title" align="center" style="color:#FFF;">Circle Wise Partner Wise </h4>
								<table id="datatable" class="display nowrap"  style="width:100%;text-align:center;font-size:11px;">
										<thead>
											<tr class="trb">
												<th>Partner Name</th>
												<th>Total Count</th>
