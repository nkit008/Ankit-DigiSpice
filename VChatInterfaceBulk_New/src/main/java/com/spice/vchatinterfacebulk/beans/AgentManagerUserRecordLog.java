...
@Entity
@Table(name="tbl_UI_Partner_Agent_log")

public class AgentManagerUserRecordLog {
	...
	/*
	 * @Column(name="removeDate") private Date removeDate;
	 */
	
	@Column(name="removeBy")
	...
	public String toString() {
		...
		builder.append("AgentManagerUserRecordLog [id=");
		builder.append(id);
		...
		builder.append(insertDate);
		/*
		 * builder.append(", removeDate="); builder.append(removeDate);
		 */
		builder.append(", removeBy=");
		builder.append(removeBy);
		builder.append("]");
