								...
								<form class="form-horizontal m-t-10" action="agentmanagercreate" method="post" style="border:1px dotted; black" enctype="multipart/form-data">
									<div class="form-group">
										<h4 class="page-title" align="center"><mark> New Addition </mark></h4>
											...
											<div class="form-group">
												<label class="control-label no-padding-right col-md-3 blckcolor" for="agentCircle" style="text-align:right;padding-right:40px;">Agent Circle  <span class="required">* </span></label>
											...
											<div class="form-group">
												<label class="control-label no-padding-right col-md-3 blckcolor" for="agentDocImage" style="text-align:right;padding-right:40px;">Agent Document Image <span class="required">* </span></label>
											...
											<div class="form-group">
												<label class="control-label no-padding-right col-md-3 blckcolor" for="venderCertificateImage" style="text-align:right;padding-right:40px;">Vender Certificate Image <span class="required">* </span></label>
