									...
									<div class="form-group">
										<h4 class="page-title" align="center"><mark> Agent Update </mark></h4>
											...
											<div class="form-group">
												...
												placeholder="Please Enter 10 Digits ANI" required="required" autocomplete="off" readonly  style="background-color: #f7f5f5;"/>	
											</div> 
											...
											<div class="form-group" style="display: none" id="agentLocation">
												<label class="control-label no-padding-right col-md-3 blckcolor" for="newLocation" style="text-align:right;padding-right:40px;">Agent Circle  <span class="required">* </span></label>
											...
											<div class="form-group" style="display: none" id="newAni">
												<label class="control-label col-md-3" for="newAni blckcolor" style="text-align:right;padding-right:40px;">New Number  <span class="required">* </span></label>		
