										...
										<form action="edituser"
											...
											<p style="font-size:16px;font-weight:bold;margin-top:2%;margin-bottom:3%;">Agent Request Status</p>
												...
												<div class="form-group">
													...
													<input type="text" name="userHub" id="userHub" class="col-md-4" readonly style="background-color: #f7f5f5;"/>	
												</div>
												...
												<div class="form-group">
													...
													<input type="text" name="bAni" id="bAni" class="col-md-4" autocomplete="off" readonly style="background-color: #f7f5f5;"/>	
												</div>
												<div class="form-group">
												...
												<c:if test="${(userObj.role eq 'Admin') || (userObj.role eq 'admin')  || (userObj.role eq 'superadmin') || (userObj.role eq 'SuperAdmin')}">
													<div class="form-group">
														<label class="control-label col-md-3 blckcolor" for="priorityFlag" style="text-align:right;padding-right:40px;">Priority Flag  <span class="required">* </span></label>		
