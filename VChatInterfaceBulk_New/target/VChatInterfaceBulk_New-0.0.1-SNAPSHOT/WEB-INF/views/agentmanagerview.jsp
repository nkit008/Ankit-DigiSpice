									...
									<form action="agentmanagerupdateAction"
										...
										<p style="font-size:16px;font-weight:bold;margin-top:2%;margin-bottom:3%;">Agent Request Status</p>
											...
											<div class="form-group">
												<label class="control-label col-md-3 blckcolor" for="operator" style="text-align:right;padding-right:40px;">Operator  <span class="required">* </span></label>		
											...
											<div class="form-group" id="newNumber2" style="margin-left: 177px;">
												...
												placeholder="" required="required" autocomplete="off" readonly style="background-color: #f7f5f5;"/><span Style="float: right;margin-right:113px;">
											...
											<div class="form-group" id="newNumber1">
												<label class="control-label col-md-3 blckcolor" for="newNumber" style="text-align:right;padding-right:40px;">New Number  <span class="required">* </span></label>		
											...
											<div class="form-group" id="allocatedCircle1">
												<label class="control-label col-md-3 blckcolor" for="allocatedCircle" style="text-align:right;padding-right:40px;">Allocated Circle  <span class="required">* </span></label>		
											...
											<div class="form-group" id="chatId1">
												<label class="control-label col-md-3 blckcolor" for="chatId" style="text-align:right;padding-right:40px;">Chat Id  <span class="required">* </span></label>		
												<input type="text" name="chatId" id="chatId" class="col-md-4"
												placeholder="" autocomplete="off"/>	
											</div>
											<div class="form-group" id="location1">
												<label class="control-label col-md-3 blckcolor" for="location" style="text-align:right;padding-right:40px;">Location  <span class="required">* </span></label>		
											...
											<div class="form-group" id="type1">
												<label class="control-label col-md-3 blckcolor" for="type" style="text-align:right;padding-right:40px;">Type  <span class="required">* </span></label>		
														...
														<c:if test="${(userObj.role eq 'Admin') || (userObj.role eq 'admin') || (userObj.role eq 'superadmin') || (userObj.role eq 'SuperAdmin')}">
															<td>
																<div class="hidden-sm hidden-xs action-buttons">
																	<input type="button" class="btn-warning" data-toggle="modal"
																		...
																		'${listValue.status}','${listValue.documentPath}','${listValue.certificatePath}','${listValue.id}','${listValue.hub}')" value="Action" />
