					...
					<c:if test="${userObj.role eq 'limit'}">
						<ul class="navigation-menu">
							...
							<li class="has-submenu"><a href="agentmanagerrecords">Agent Manager</a>
								<ul class="submenu">
				  					<li><a href="agentmanagercreate">New Addition</a></li>
				  					<li><a href="agentmanagerrecords">Approved Agents </a></li>
				  					<li><a href="agentmanagerview">Pending Request Status</a></li>
				  					<li><a href="agentmanagerviewfinal">Complete Request Status</a></li>
