							...
							<div class="p-20">
								<form class="form-horizontal m-t-10" action="resetpasswordAction" method="post" style="border:1px dotted; black">
										...
										<div class="form-group">
											<label class="col-md-2 blckcolor" for="loginId">User Name <span class="required">* </span></label>
											<input type="text" name="loginId" id="loginId" class="col-md-2 blckcolor"
												placeholder="Enter Chat Id" required="required" autocomplete="off"/>
											
										</div>
										<div class="form-group">
											<label class="control-label no-padding-right" for="newPassword" style="padding-right: 46px;">Password  <span class="required">* </span></label>		
											<input type="password" name="newPassword" id="txtPassword" class="col-md-5"
												placeholder="Please Enter User Password" required="required" autocomplete="off"/><br/>
												&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;&#x00A0;<input type="checkbox" onclick="myFunction()" style="vertical-align:-2px;">Show Password	
										</div>
										
										
										<div class="form-group">
											<label class="control-label no-padding-right" for="confirmPassword" style="padding-right: 5px;">Confirm Password  <span class="required">* </span></label>		
