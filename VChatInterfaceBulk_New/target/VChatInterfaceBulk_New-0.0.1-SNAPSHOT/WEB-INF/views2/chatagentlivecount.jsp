...
<body>
    ...
    <div class="lwidth">
					<div class="card">
						<div class="card-body">
							<div class="x_content">
								<h4 class="page-title" align="center"><mark> Zone Wise </mark></h4>
                ...
                <div class="lwidth">
					<div class="card">
						<div class="card-body">
							<div class="x_content">
								<h4 class="page-title" align="center"><mark> Circle Wise </mark></h4>
...
<div class="lwidth">
					<div class="card">
						<div class="card-body">
							<div class="x_content">
								<h4 class="page-title" align="center"><mark> Partner Wise </mark></h4>
