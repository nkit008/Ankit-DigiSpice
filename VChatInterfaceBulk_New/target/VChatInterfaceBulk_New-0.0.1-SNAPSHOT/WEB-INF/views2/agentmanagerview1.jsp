									...
									<form action="agentmanagerupdateAction"
										...
										<p>Agent Request Status</p>
											...
											<div class="form-group">
												...
												placeholder="" required="required" autocomplete="off" readonly/>	
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												placeholder="" autocomplete="off" readonly="readonly"/>	
											</div>
											<!-- <div class="form-group">
												<label class="control-label col-md-3" for="document">Document  <span class="required">* </span></label>		
												<input type="text" name="document" id="document" class="col-md-4"
												placeholder="" autocomplete="off" readonly/>	
											</div> -->
											<!-- <div class="form-group">
												<label class="control-label col-md-3" for="documentNumber">Document Number  <span class="required">* </span></label>		
												<input type="text" name="documentNumber" id="documentNumber" class="col-md-4"
												placeholder="" autocomplete="off" readonly/>	
											</div> -->
											<!-- <div class="form-group">
												<label class="control-label col-md-3" for="agentName">Agent Name  <span class="required">* </span></label>		
												<input type="text" name="agentName" id="agentName" class="col-md-4"
												placeholder="" autocomplete="off" readonly/>	
											</div> -->
											<!-- <div class="form-group">
												<label class="control-label col-md-3" for="age">Age  <span class="required">* </span></label>		
												<input type="text" name="age" id="age" class="col-md-4"
												placeholder="" autocomplete="off" readonly/>	
											</div> -->
											<!-- <div class="form-group">
												<label class="control-label col-md-3" for="languages">Languages  <span class="required">* </span></label>		
												<input type="text" name="languages" id="languages" class="col-md-4"
												 autocomplete="off" readonly/>	
											</div> -->
											<div class="form-group">
