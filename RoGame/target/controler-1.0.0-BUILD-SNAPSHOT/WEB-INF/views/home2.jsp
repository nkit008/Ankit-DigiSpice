			...
			<body>
				<form action="mis" method="post" name="form1">
					<table width="845" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="845" colspan="3" align="left" valign="top"><img
						...
						<tr>
							<td colspan="3" align="left" valign="top" class="mid"><div
									id="login-wrapper" style="width: 843px; margin-left: 12px;">
									<div
...
<td>
										 ...
										 <select name="accessService" onchange="pagerefresh()">
 ...
 <c:choose>
  ...
  <c:otherwise>
   ...
   <option value="Lifestyle">Lifestyle</option>
									...
									<div>
										<div class="to" style="font-size: 12px;">
										...
										<div class="from" style="font-size: 12px;">
