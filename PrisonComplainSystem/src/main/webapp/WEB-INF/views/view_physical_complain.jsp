        ...
        <div class="page-title-box">
          <div class="float-right">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Physical Damage Complains</li>
            </ol>
          </div>
          <h4 class="page-title">Physical Damage Complains</h4>
        </div>
      </div>
    </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="editPhysicalComplain" method="post" id="editform">
            <div class="row">
...
function goBack()
{
	...
	window.location.href=getContextPath()+"/homepage";
