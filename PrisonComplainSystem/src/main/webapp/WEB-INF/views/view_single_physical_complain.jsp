        ...
        <div class="page-title-box">
          <div class="float-right">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Physically Damage Complain</li>
            </ol>
          </div>
          <h4 class="page-title">Physically Damage Complain</h4>
        </div>
      </div>
    </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="editSinglePhysicalComplain" method="post" id="editform">
            <div class="row">
...
function goBack()
{
	...
	window.location.href=getContextPath()+"/viewphysicalcomplain";
