    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="page-title-box">
          ...
          <h4 class="page-title">Software Complain</h4>
        </div>
      </div>
    </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="editSingleSftwareComplain" method="post" id="editform">
            <div class="row">
...
function goBack()
{
	...
	window.location.href=getContextPath()+"/viewsoftwarecomplain";
