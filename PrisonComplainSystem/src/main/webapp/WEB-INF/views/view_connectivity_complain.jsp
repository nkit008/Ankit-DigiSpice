        ...
        <div class="page-title-box">
          <div class="float-right">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Connectivity Complains</li>
            </ol>
          </div>
          <h4 class="page-title">Connectivity Complains</h4>
        </div>
      </div>
    </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="editconnectivityComplain" method="post" id="editform">
            <div class="row">
