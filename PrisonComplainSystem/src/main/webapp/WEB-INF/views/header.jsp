    ...
    <div class="container-fluid">
      <div id="navigation"><!-- Navigation Menu-->
        <ul class="navigation-menu">
          ...
          <li class="has-submenu"><a href="#"><i class="mdi mdi-pencil"></i>New Complain</a>
            <ul class="submenu">
          ...
          <li class="has-submenu"><a href="#"><i class="mdi mdi-bullseye"></i>View  complains</a>
            <ul class="submenu">
          ...
          <c:if test="${userObj.user_role eq 'spice_admin'}">
                    <li class="has-submenu"><a href="#"><i class="mdi mdi-account-plus"></i>Users</a>
            <ul class="submenu" style="margin-left: 40px;">
              <li><a href="adduser">Add User</a></li>
              <li><a href="updateUser">Update User</a></li>
              <li><a href="viewAllUser">View User</a></li>
            </ul>
          </li>          
           </c:if>
