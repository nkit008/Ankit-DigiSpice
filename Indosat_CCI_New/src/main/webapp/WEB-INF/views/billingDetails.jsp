...
<div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row" >
                <div class="col-lg-12">
                    <div class="card m-b-20">
						...
						<h6 id="msg" style="text-align: center;color:#f4ad42;font-weight: bold;">${msg}</h6>
                            <h4 class="mt-0 header-title">User Billing Details</h4>
                            

                            <form class="" action="showBillingDetails" method="post">
              ...
              <div id ="unsubNumber">
					<c:if test="${not empty billingDetails}">
