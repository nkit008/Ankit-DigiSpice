                ...
                <div class="col-lg-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form class="" action="fetchMisNew" method="post">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="fromDate" placeholder="mm/dd/yyyy" id="datepicker-autoclose" required="required" autocomplete="off" value="${from}">
                  ...
                  <!-- input-group --></div>
					...
					<div class="form-group">
                      ...
                      <div>
                  <div class="input-group">
                    <input type="text" class="form-control" name="toDate" placeholder="mm/dd/yyyy" id="datepicker-autoclose2" required="required" autocomplete="off"  value="${to}">
                    <div class="input-group-append bg-custom b-0"><span class="input-group-text"><i class="mdi mdi-calendar"></i></span></div>
                  </div>
                  <!-- input-group --></div>
                  ...
                  <!-- input-group --></div>
                    ...
                    <tr  bgcolor="#FFFFFF" >
                        <td rowspan="4" align="center"  bgcolor="#C3FDB8" colspan="2" >Mode of Un-Subscription</td>
                        ...
                        %>
                        <td align="center" bgcolor="#efefef" class="table_text"><%=hm.get("IVR_UNSUBS")%></td> <%}%>
                    </tr>
                    <tr bgcolor="#FFFFFF" >

                        <td height="31"  bgcolor="#efefef" align="center" >CCI</td>
                        <%
                        ...
                        %>
                        <td align="center" bgcolor="#efefef" ><%=hm.get("CCI_UNSUBS")%></td> <%}%>
                    </tr>

                    <tr bgcolor="#FFFFFF" >
                        <td height="31" align="center"  bgcolor="#efefef" class="table_text" >SMS</td>
                        <%
                        ...
                        %>
                        <td align="center"   bgcolor="#efefef" class="table_text" ><%=hm.get("SMS_UNSUBS")%></td> <%}%>
                    </tr>
                    ...
                    <tr bgcolor="#FFFFFF" >
                        <td rowspan="5" align="center" colspan="2" > Mode of Download</td>
                        <td height="31" align="center"  bgcolor="#efefef" class="table_text">IVR</td>
                        <%
                            for (int i = 0; i < infoArrayList.size(); i++) {
                                HashMap hm = (HashMap) infoArrayList.get(i);
                    ...
                    <tr bgcolor="#FFFFFF" >
                        ...
                        <%
                            for (int i = 0; i < infoArrayList.size(); i++) {
                                HashMap hm = (HashMap) infoArrayList.get(i);
                        %>
                        <td align="center"  class="table_text" ><%=hm.get("OTHERS_DWLD")%></td> <%}%>
                    </tr>
