...
<!-- Title -->
<title>ZamtelGames Bulk Subscription</title>
...
<div class=" app-content my-3 my-md-5">
      <div class="side-app"> 
        <div class="mb-5">
          <div class="page-header  mb-0">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Zamtel</li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <form action="zamtelGamesBulkSubscriptionAction" method="post" enctype="multipart/form-data" onsubmit="return validate()">
