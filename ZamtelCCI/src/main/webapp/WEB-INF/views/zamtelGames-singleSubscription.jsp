...
<!-- Title -->
<title>ZamtelGames Single Subscription</title>
        ...
        <div class="mb-5">
          <div class="page-header  mb-0">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Zamtel Games</li>
              ...
              <div class="card-body">
				...
				<div class="col-md-6 col-lg-6">
					...
					<label style="width:70%;">Select Price Point<span style="color:red;font-weight:bold;font-size:13px;">*</span></label>
                      ...
                      <option value="GAMES_SUB1">Games_Monthly</option>
                      <option value="GAMES_SUB2">Games_Weekly</option>
                      <option value="GAMES_SUB3">Games_Daily</option>
                      </select>
                    </div>
...
function validate()
	...
	$.confirm({
	    ...
	    buttons: {
	        confirm: function () {
	window.location.href=getContextPath()+"/zamtelGamesSingleSubscriptionAction?ani="+a+"&pricePoint="+b;
	        },
	        cancel: function () {
