...
<!-- Title -->
<title>ZamtelGames Billing Details</title>
...
<div class=" app-content my-3 my-md-5">
      <div class="side-app"> 
        <div class="mb-5">
          <div class="page-header  mb-0">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Zemtal Beatz</li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <form  class="card" action="zamtelBeatsBillingDetailsAction" method="post" onsubmit="return validate();">
      ...
      <c:if test="${fn:length(billingList) gt 0}">
        ...
        <div class="card">
          <div class="card-body">
              ...
              <table id="sub" class="display nowrap" style="width:100%">
                ...
                <tbody>
                <c:forEach var="open" items="${billingList}">
                <tr style="text-align: center;">
                	<td>${open.ani}</td>
                	<td>${open.status}</td>
                	<td>${open.subDate}</td>
                	<td>${open.billingDate}</td>
                	<td>${open.renewDate}</td>
                	<td>${open.prePost}</td>
                	<td>${open.amtDeducted}</td>
                	<td>${open.packType}</td>
                	<td>${open.actSource}</td>
                	<td>${open.serviceType}</td>
...
function validate()
{
	var pattern= /^[0-9]+$/;
		...
		{
			toastr.info("Please Insert only Digits");
			$('#ani').focus();
			return false;
		}
			...
			{
				toastr.info("Number length should be 9");
				$('#ani').focus();
				return false;
			}
