...
<!-- Title -->
<title>ZamtelBeatz Bulk Subscription</title>
...
<div class=" app-content my-3 my-md-5">
      <div class="side-app"> 
        ...
        <div class="row">
          <div class="col-lg-12">
            <form action="zamtelBeatsBulkSubscriptionAction" method="post" enctype="multipart/form-data" onsubmit="return validate()">
...
function validate()
	...
	if($('#pricePoint').val() == '-1')
	{
		toastr.info("Please Select Price Point");
		$('#pricePoint').focus();
		return false;
	}
