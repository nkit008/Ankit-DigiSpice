...
<div class=" app-content my-3 my-md-5">
      <div class="side-app"> 
        <div class="mb-5">
          <div class="page-header  mb-0">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Zemtal</li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <form  class="card" action="zamtelGamesBillingDetailsAction" method="post" onsubmit="return validate();">
