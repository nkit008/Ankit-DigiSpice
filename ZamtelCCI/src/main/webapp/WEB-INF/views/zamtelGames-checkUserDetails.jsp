...
<!-- Title -->
<title>ZamtelGames User Details</title>
...
<div class=" app-content my-3 my-md-5">
      <div class="side-app"> 
        ...
        <div class="row">
          <div class="col-lg-12">
            <form  class="card" action="zemtalGamesDetailsAction" method="post" onsubmit="return validate();">
	...
	<c:if test="${tableExist eq 'yes'}">
      <p style="text-align:center;font-size:16px;font-weight:bold;">User Details</p>
        <div class="card">
          <div class="card-body">
      ...
      <table id="unsub" class="display nowrap" style="width:100%">
                ...
                <tr style="text-align: center;">
					...
					<td>${data.quantity}</td>
                	<td>${data.subDate}</td>
                	<td>${data.lastBillingDate}</td>
                	<td>${data.nextBillingDate}</td>
                	<td>${data.actSource}</td>
                	<td>${data.status}</td>
                  </tr>
                </tbody>
              </table>
