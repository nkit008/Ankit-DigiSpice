...
var MonthYearColor="#0469b7";//Font Color of Month and Year in Calendar header.
var WeekHeadColor="#0469b7";//var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor="#bce2ff";//var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor="#bce2ff";//Background color of Saturday.
var WeekDayColor="white";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#bce2ff";//var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#0469b7";//var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="#0469b7";//color of font of Year selector.
var MthSelColor="#0469b7";//color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor="#0469b7"; //color when mouse move over.
