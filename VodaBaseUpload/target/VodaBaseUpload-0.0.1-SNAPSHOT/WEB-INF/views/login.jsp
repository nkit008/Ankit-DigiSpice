...
<div class="wrapper-page" >
      		...
      		<div class="row">
		      	...
		      	<div class="col-6" align="left">
		   		...
		   		<div class="col-6" align="right">
		   			<p class="text-danger" style="font-size: 20px;font-weight:bold;">Voda Base Upload</p>
		   		</div>
		   	</div>	
      ...
      <div class="p-3">
        <form class="form-horizontal m-t-10" action="login" method="post">
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control"  placeholder="Enter password" name="userPwd" required="required" autocomplete="off">
          </div>
  ...
  <div class="m-t-40 text-center text-white-30">
    <p style="color:#fff;">© 2019 DigiSpice</p>
  </div>
</div>
