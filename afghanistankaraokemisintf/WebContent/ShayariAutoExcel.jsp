...
<%@page import="com.spice.bean.ShayariBean"%>
...
<%
    ...
    try {
        ...
        response.setHeader("Content-disposition", "inline; filename=AwccShyarai_MIS_" + myDate + ".xls");
        ShayariBean sBean = new ShayariBean();
        
        Map[] resultMap = sBean.GetData(start, end);
	...
	<table border="1" cellpadding="0" cellspacing="0"
					...
					<td colspan="${sessionScope['mapdataLength']}" style="text-align: center;font-weight:bold;">Shayari Revenue MIS</td>
										...
										<c:forEach var="map" items="${sessionScope['mapdata']}">
												...
												<tr>
													<td style="font-weight: bold;">${map['date_time']}</td>
												</tr>
											</table></td>
											</c:forEach>
										</tr>
