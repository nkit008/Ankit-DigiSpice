...
<body style="font-family: arial; font-size: 12px;">
	...
	<table border="1" cellpadding="0" cellspacing="0"
						...
						<tr>
					<td colspan="${sessionScope['mapdataLength']}" style="text-align: center;font-weight:bold;">Shayari Pack Revenue MIS</td>
					</tr>
										<tr>
			...
			<tr>
				<td style="width: 300px;text-align: center;"><font color="red">Calls</font></td>
				<td>
			...
			<! -- ============================================================================= -->
			<tr>
				<td id="2" style="text-align: center;" rowspan="5"><font color="red">Subscribers</font></td>
				<td>
					<table border="1" cellpadding="0" cellspacing="0" width="300">
						<tr>
						...
						<td>
							<table border="1" cellpadding="0" cellspacing="0" width="300">
							<tr>
								<td style="text-align: center;background-color: green;color: #ffffff;font-weight: bold;">SMS</td>
							</tr>
							<tr>
								<td>Count of Single Consent users</td>
							</tr>
						...
						<tr>
						<td id="2" style="text-align: center;"><font color="red">Subscribers Base</font></td>	
						<td>
						<table border="1" cellpadding="0" cellspacing="0" width="300">
							<tr>
								<td>Net Additions</td>
						...
						<tr>
						<td id="2" style="text-align: center;"><font color="red">Content Delivery</font></td>	
						<td>
						<table border="1" cellpadding="0" cellspacing="0" width="300">
							<tr>
					...
					<tr>
						<td id="2" style="text-align: center;"><font color="red">Revenue</font></td>	
						<td>
						<table border="1" cellpadding="0" cellspacing="0" width="300">
							<tr>
						...
						<tr>
						<td id="2" style="text-align: center;"><font color="red">MOU'S Split</font></td>	
						<td>
						<table border="1" cellpadding="0" cellspacing="0" width="300">
							<tr>
