...
<div style="color:#4a59ad; font-size:14px; margin:0px; padding-top:16px; color:#3d3d3d;text-align: center;"><span style="color:#0244b4;">AFGHANISTAN KARAOKE</span><span style="color:#f00027;"> MIS</span></div>&nbsp;
<div></div>
...
<div>
  ...
  <a href="downloadAwcc.jsp" style="text-decoration: none; color: #153f99;">AWCC MIS REPORT</a><img src="images/excel.jpg" width="16" height="16" align="absmiddle" style="padding-left:9px;">
  </div>

<!--Template end here-->
<c:if test="${sessionScope.result eq 'a'}">
 <div id="excelAwcc">
<jsp:include page="excelAwcc.jsp"></jsp:include>
</div>
</c:if>
</body>
</html>