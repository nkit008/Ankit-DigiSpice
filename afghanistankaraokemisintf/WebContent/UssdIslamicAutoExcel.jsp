<%@page import="com.spice.bean.UssdIslamicBean"%>
...
<%
    ...
    try {
        ...
        response.setHeader("Content-disposition", "inline; filename=AwccIslamicUssd_MIS_" + myDate + ".xls");
		...
		<tr>
			...
			<td  align="left">
				 <table cellpadding="0" cellspacing="0" border="1">
					<tr><c:forEach var="map" items="${sessionScope['mapdata'] }">
					<td style="font-weight: bold;"><div style= "width: 100px;">${map['date_time']}</div></td></c:forEach></tr>
				</table> 
			</td>
		</tr>
		<tr>
