...
<div style="color:#4a59ad; font-size:14px; margin:0px; padding-top:16px; color:#3d3d3d;text-align: center;"><span style="color:#0244b4;">USSD INFO</span><span style="color:#f00027;"> MIS</span></div>&nbsp;
<div></div>
...
<div align="center" style="font-size:12px; padding-top:32px; padding-bottom:32px;"><strong>Select Service</strong> 
  <select class="list spcr2" name="accessService" style="width:231px; border:1px solid #d9d9d9;" onchange="pagerefresh()">
  	<option value="info" selected="selected">USSD_INFO</option>
...
<div>
  ...
  <a href="downloadInfo.jsp" style="text-decoration: none; color: #153f99;">USSD INFO MIS REPORT</a><img src="images/excel.jpg" width="16" height="16" align="absmiddle" style="padding-left:9px;">
  </div>
<!--Template end here-->
<c:if test="${sessionScope.result eq 'a'}">
 <div>
<jsp:include page="excelInfo.jsp"></jsp:include>
</div>
</c:if>
</body>
</html>