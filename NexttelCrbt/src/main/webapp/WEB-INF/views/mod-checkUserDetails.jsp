...
<div class=" app-content my-3 my-md-5">
      <div class="side-app"> 
        ...
        <div class="row">
          <div class="col-lg-12">
            <form  class="card" action="mod-UserDetailsAction" method="post" onsubmit="return validate();">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <!-- <div class="col-md-6 col-lg-6">
					<div class="form-group">
                      <label class="form-label">Detail Type<span style="color:red;font-weight:bold;font-size:13px;">*</span></label>
...
<p>Current Status is --  <button class="btn addnew-db" style=" margin-top:-0px;" onclick="viewCurStatusRecord()"><span style="color: green;font-weight: bold;text-decoration: underline;">${status}</span></button> <span style="font-size: 13px;">(Click here for Details)</span></p>
</c:if>        
...
function viewCurStatusRecord()
{
	...
	window.location.href=getContextPath()+"/neXtMusicUserDetailsActionDetails?ani=${mobile}&status=${status}";
