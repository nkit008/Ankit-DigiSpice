              ...
              <div class="card-body">
				...
				<div class="col-md-6 col-lg-6">
					...
					<label style="width:70%;">Select Price Point<span style="color:red;font-weight:bold;font-size:13px;">*</span></label>
                      ...
                      <option value="MS_SUB1">Yearly</option>
                      <option value="MS_SUB2">Monthly</option>
                      <option value="MS_SUB3">Weekly</option>
                      <option value="MS_SUB4">Daily</option>
                      </select>
                    </div>
...
function validate()
	...
	if(!pattern.test($('#ani').val()) &&  $('#ani').val().length != 12)
	{
		alert("ani should be numeric and 12 digits");
		$('#ani').focus();
		return false;
	}
	...
	$.confirm({
	    ...
	    buttons: {
	        confirm: function () {
	window.location.href=getContextPath()+"/neXtVoiceSingleSubscriptionAction?ani="+a+"&pricePoint="+b;
	        },
	        cancel: function () {
