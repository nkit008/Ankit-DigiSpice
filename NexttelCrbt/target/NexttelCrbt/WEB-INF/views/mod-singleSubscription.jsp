          ...
          <div class="col-lg-12">
            <form  class="card" method="post" onsubmit="return validate();">
              ...
              <div class="card-body">
				...
				<div class="col-md-6 col-lg-6">
					<div class="form-group">
					<label style="width:70%;">Select Price Point<span class="sta-red">*</span></label>
...
function validate()
	...
	$.confirm({
	    ...
	    buttons: {
	        confirm: function () {
	window.location.href=getContextPath()+"/mod_SingleSubscriptionAction?ani="+a+"&pricePoint="+b;
	        },
	        cancel: function () {
