			...
			<thead style="color:#fff;background-color:#212529;border-color:#32383e">
				...
				<c:forEach var="data" items="${record}">
					<tr>
						...
						<c:choose>
    						<c:when test="${loginObj.role ne 'admin' && data.loginStatus eq 'FLOGOUT'}">
        						<td><input type="button" disabled="disabled" data-toggle="modal" data-target="#EditModal" value="Edit" onclick="set('${data.bAni}','${data.loginStatus}')"></td> 
        						<br />
    						</c:when>    
    					<c:otherwise>
						...
						<div class="modal" id="EditModal" role="dialog">
								<div class="modal-dialog modal-lg"  style="margin-top:12%;width:50%;">
									...
									<div class="modal-content"">
										...
										<form action="editLoginStatusPartner"
