...
<div class="col-lg-4 col-md-12 col-sm-12">
<div class="row">
<div class="fleft">Sub-Category:
</div>
<div class="fright"><select class="inpt" id="subcategory" name="subcategory" placeholder="Sub Category" required="">
...
<div class="fright"><select class="inpt" id="edit-subcategory" name="subcategory" placeholder="Sub Category" required="">
    <option value="" disabled selected>Select Sub-Category</option>
    <option value="expert">Expert</option>
    <option value="voicechat">Voice Chat</option>
    </select>
...
<table id="agentlist" class="display nowrap" style="width:100%;text-align: center;">
				...
				<c:forEach var="data" items="${records}">
					<tr>
						...
						,'${data.hub}','${data.circle}','${data.location}','${data.agent_type}','${data.subcategory}','${data.age}','${data.gender}'
...
function myFunction() {
  ...
  if (x.className === "topnav") {
	...
	function editValues(a,b,c,d,e,f,g,g1,h,i,j,k,l)
	{
		 $('#addNewAgent').hide();
		 $('#editNewAgent').show();
		...
		document.getElementById("edit-subcategory").value=g1;
