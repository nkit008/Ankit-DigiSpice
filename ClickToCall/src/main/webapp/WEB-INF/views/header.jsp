    ...
    <div class="container-fluid"><!-- LOGO -->
      ...
      <nav class="navbar-custom"><!-- Search input -->
        ...
        <ul class="list-unstyled topbar-nav mb-0 dsg">
          <li class="hidden-sm"><a class="nav-link waves-effect waves-light" href="viewPlaylist"><i class="fa fa-list-alt mr-2"></i>View Playlist</a></li>
